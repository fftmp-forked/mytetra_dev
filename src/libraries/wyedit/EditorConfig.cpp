...
QStringList EditorConfig::get_parameter_table_3(bool withEndSignature) {
    ...
    table << "tools_line_1"
          << "QString"
          << "clear,separator,bold,italic,underline,separator,monospace,code,alignleft,aligncenter,alignright,alignwidth,fontselect,fontsize";
    table << "tools_line_2"
          << "QString"
          << " ";
...
QStringList EditorConfig::get_parameter_table_20(bool withEndSignature) {
    ...
    table << "mathExpressionUpdateTime"
          << "int"
          << "1";
